  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10">
        ...
        <div className="absolute top-1/2 right-1/3 w-16 h-16 bg-white/10 rounded-full blur-md animate-pulse"></div>
      </div>
          ...
          >
            ...
            >
              ...
              <div className="space-y-6 relative">
                <div className="absolute -top-4 -left-4 w-20 h-20 bg-primary-yellow/10 rounded-full blur-xl animate-pulse-slow"></div>
                <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight text-white drop-shadow-2xl relative">
                  ...
                  <div className="absolute -bottom-2 left-0 w-24 h-1 bg-gradient-to-r from-primary-yellow to-primary-yellow/50 rounded-full"></div>
                </h1>
              </div>
              ...
              <div className="space-y-8">
                <div className="relative group">
                  ...
                  <p className="relative text-base sm:text-lg leading-relaxed text-white/95 bg-gradient-to-br from-white/15 via-white/10 to-white/5 dark:from-dark-bg/40 dark:via-dark-bg/30 dark:to-dark-bg/20 backdrop-blur-md rounded-2xl p-8 border border-white/30 dark:border-primary-yellow/30 shadow-xl">
                    ...
                    <div className="absolute top-4 left-4 text-primary-yellow/30 text-4xl font-serif">
                      &ldquo;
                    </div>
                    <div className="absolute bottom-4 right-4 text-primary-yellow/30 text-4xl font-serif rotate-180">
                      &rdquo;
                    </div>
                  </p>
                </div>
