...
export default function Footer() {
  ...
  const quickLinks = [
    ...
    { name: footer("services"), href: `/${locale}/services` },
    { name: footer("branches"), href: `/${locale}/branches` },
    { name: footer("clients"), href: `/${locale}/clients` },
    { name: footer("faq"), href: `/${locale}/faq` },
    { name: footer("trackOrder"), href: `/${locale}/track-order` },
    { name: footer("login"), href: `/${locale}/login` },
  ];

  return (
    <footer className="bg-[#212529] text-[#f2c928]">
          ...
          <div className="flex flex-col items-center md:items-start">
            ...
            <div className="flex gap-4 justify-center md:justify-start">
              ...
              <a
                ...
                className="text-gray-400 hover:text-blue-400 transition-colors duration-200 pt-4"
                aria-label="LinkedIn"
              >
                <svg
                  className="h-6 w-6"
