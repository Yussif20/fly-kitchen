...
export default function Header() {
  ...
  return (
    <div className="relative z-30">
      <header
        className={`fixed z-50 border-b bg-primary-yellow text-dark-bg dark:bg-dark-bg dark:text-primary-yellow transition-all duration-300 w-full
          ${
            scrolled
          ...
          <div className="flex items-center justify-between h-20 py-4 px-4">
            ...
            <div className="flex items-center gap-4 order-4 relative">
              ...
              <div ref={settingsRef} className="relative">
                <button
                  className="p-2 rounded-full hover:bg-dark-bg/20 dark:hover:bg-primary-yellow/10 transition-colors"
                  aria-label="Settings"
                ...
                {showSettings && (
                  <div
                    className={`absolute mt-3 max-w-[90vw] z-50 flex flex-col gap-4 p-4 rounded-2xl shadow-2xl border border-primary-yellow/30 dark:border-primary-yellow/20 backdrop-blur-xl bg-white/80 dark:bg-dark-bg/80 ring-1 ring-primary-yellow/10 ${
                  ...
                  >
                    ...
                    <span
                      className={
                        ...
                        " w-4 h-4 bg-white dark:bg-dark-bg rotate-45 border-t border-l border-primary-yellow/30 dark:border-primary-yellow/20 shadow-sm"
                      }
                      style={{ zIndex: 51 }}
                    />
